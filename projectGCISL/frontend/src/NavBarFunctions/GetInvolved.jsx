...
const GetInvolved = () => {
  return (
    <div className="get-involved">
      ...
      <p className="welcome-text">Welcome, get involved in various impactful ways.</p>
      <div className="involvement-options">
        <div className="involvement-card">
          ...
          <p>
            Your insights and participation are invaluable in advancing our knowledge and making meaningful progress in this crucial area. If you're curious about our current research projects, you can check them out <Link to={`/research`}>here.</Link>
          </p>
          <Link to={`/contact?reason=Research%20Involvement`}>
        ...
        <div className="involvement-card">
          ...
          <img src="/educationImage.png" alt="Education & Mentorship" />
          ...
          <Link to={`/contact?reason=Education%20%26%20Mentorship`}>
        ...
        <div className="involvement-card">
          ...
          <Link to={`/contact?reason=Outreach%20%26%20Charitable%20Contributions`}>
